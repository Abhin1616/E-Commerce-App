...
const CustomerAddAddress = () => {
    let location = useLocation()
    const navigate = useNavigate()
    const { register, handleSubmit, formState: { errors }, reset, setValue, watch } = useForm({ defaultValues: { addressType: "home" } })
    ...
    const onSubmit = (data) => {
        axios.post("http://localhost:3000/shoppingApp/customer/profile/address", { ...data }, {
            headers: {
    ...
    return (
        <div className="border-solid border-2 border-b border-gray-300 pb-12 w-2/5 mx-auto p-8 mt-10 rounded-md bg-white my-20 shadow-2xl pt-10">
            <h1 className=" mb-10 text-center text-3xl font-bold">Add your Address</h1>
