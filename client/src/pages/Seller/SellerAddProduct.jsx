...
const SellerAddProduct = () => {
    ...
    const onSubmit = (formData) => {
        ...
        try {
            ...
            axios.post("http://localhost:3000/shoppingApp/seller/home", data, {
                headers: {
                ...
                .then((res) => {
                    setLoading(false)
                    enqueueSnackbar("Product Added Sucessfully!", {
                    ...
                    console.log(res)
                    navigate("/shoppingApp/seller/products")
                })
                .catch((err) => {
                    setLoading(false)
                    console.log(err)
    ...
    return (
        <form encType="multipart/form-data" onSubmit={handleSubmit(onSubmit)} >
            {loading ? (<LoadingSpinner />) : (<div className='border-solid border-2 border-b border-gray-900/10 pb-12 w-2/5 mx-auto p-8 mt-10 rounded-md bg-gray-100 mb-20'>
                <h1 className='text-center text-3xl font-semibold mb-7'>Add Product</h1>
