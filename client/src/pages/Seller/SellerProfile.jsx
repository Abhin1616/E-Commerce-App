...
const SellerProfile = () => {
    ...
    useEffect(() => {
        axios.get("http://localhost:3000/shoppingApp/seller/profile", {
            headers: {
                        ...
                        <div className='grid grid-cols-9 gap-4'>
                            <div className='col-span-2'>
                                ...
                                <div className="rounded-lg shadow-md flex flex-col mt-10 bg-white py-6">
                                    <div className='text-xl font-bold mb-3 text-gray-500 flex justify-between items-center cursor-pointer hover:text-blue-600 px-6' onClick={() => { navigate("/shoppingApp/seller/view-orders") }} >
                                        <span>Orders</span>
                                    ...
                                    <div className={`cursor-pointer px-6 font-semibold hover:text-blue-600 hover:bg-teal-50 py-2 text-blue-600 bg-teal-50`}>
                                        Profile
                                    </div>
                                </div>

                            </div>
                            <SellerEditProfile seller={profile} setRefresh={setRefresh} />
                        </div>
